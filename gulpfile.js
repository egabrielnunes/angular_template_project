...
gulp.task('sass', function () {
    ...
    gulp.src('src/scss/*.scss')
        ...
        .pipe(notify("sass finished, css created and moved to app"));
});
...
// default task
//gulp.task('default', ['html', 'css', 'sass', 'lint', 'scripts', 'watch-sass', 'watch-js']);
gulp.task('default', ['html', 'css', 'sass', 'lint', 'scripts']);